                ...
                <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12 col-lg-3">
                            <h5>Social Media</h5>
                            <ul class="list-unstyled">
                            <li><img src="images/instagram.svg" alt="" width="15px" height="15px">  <a href="https://www.instagram.com/ptsasindonesia/">Instagram</a></li>
                            <li><img src="images/facebook.svg" alt="" width="15px" height="15px">  <a href="https://www.facebook.com/sentinaartasumberdaya">Facebook</a></li>
                            <li><img src="images/youtube.svg" alt="" width="15px" height="15px">  <a href="#">Youtube</a></li>
                            </ul>
                        </div>
                        <div class="col-12 col-lg-3">
                            <h5>Get Connected</h5>
